...
fun loadResourceAsString(name: String, charset: Charset = Charset.defaultCharset()) = String(loadResourceAsBytes(name), charset)
...
fun copyFileFromResource(name: String, target: String) = File("".javaClass.getResource(name)!!.toURI()).copyRecursively(File(target), true)
